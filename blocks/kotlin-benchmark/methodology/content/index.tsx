            ...
            <div className={styles.inner}>
                <section className={styles.section}>
                    ...
                    <p className={cn(styles.text, textCn('rs-text-2'))}>
                        ...
                        detekt, okhttp, dataframe), JVM tooling and IDE plugins (ORT, TeXiFy-IDEA, Gradle Shadow),
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.tableCard}>
                        <table className={styles.table} data-testid="methodology-dataset-table">
                            <thead>
                                <tr>
                                    <th className={cn(styles.th, textCn('rs-text-3'))} scope="col">
                                        Repository
                                    </th>
                                    <th className={cn(styles.th, styles.thNum, textCn('rs-text-3'))} scope="col">
                                        Tasks
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                {repositories.map((repo) => (
                                    <tr key={repo.name} className={styles.row} data-testid="methodology-dataset-row">
                                        <td className={cn(styles.td, textCn('rs-text-2'))}>
                                            <a
                                                className={textCn('rs-link', { external: true })}
                                                href={repo.url}
                                                target="_blank"
                                        ...
                                        <td
                                            className={cn(styles.td, styles.tdNum, textCn('rs-text-2'))}
